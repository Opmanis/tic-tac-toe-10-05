// const cells = document.querySelectorAll('.cell'); atrod masivu html faila

// for (const cell of cells) {   izsauc masivus
//   cell.addEventListener('click', clickHandle);   pieskir kliksi lai parvedotu masivu
// }
